 ...
 */
tinymce.PluginManager.add('insert_code', function(editor, url) {
	// Add a button that opens a window
	editor.addButton('insert_code', {
		title: 'Insert Code',
		image: url+'/image/insert_code.png',
		onclick: function() {
			// Open window
			editor.windowManager.open({
				...
				body: [
					{type: 'textbox', name: 'cod', label: 'Title'}
				],
				onsubmit: function(e) {
					// Insert content when the window form is submitted
					editor.insertContent( e.data.cod);
				}
			});
		}
	});
